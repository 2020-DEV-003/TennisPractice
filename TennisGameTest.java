...
public class TennisGameTest {
	...
	TennisGame game = new TennisGame("Dhileepan", "Suresh");
	...
	public void testPlayerOneWinsGame() {
		...
		String score = game.getScore();
		assertEquals("Dhileepan wins", score);
	}
	...
	public void testPlayerTwoWinsGame() {
		...
		String score = game.getScore();
		assertEquals("Suresh wins", score);
	}
	...
	public void testPlayerTwoAdvantage() {
		...
		String score = game.getScore();
		assertEquals("Advantage Suresh", score);
	}
	...
	public void testPlayerOneAdvantage() {
		...
		String score = game.getScore();
		assertEquals("Advantage Dhileepan", score);
	}
